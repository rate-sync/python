"""Base classes and interfaces for rate limiter stores.

This module provides common utilities and base classes that can be
used by different store implementations.
"""
